...
date: 2026-04-04
summary: "FMCG manufacturer case study showing how repeat purchase, cross-category lift, pack architecture, and promotion trade-offs shape household growth in Gauteng."
...
snapshot:
  problem: "Large household portfolios do not grow evenly, especially where private-label pressure and promotion dependence can distort what looks healthy on the surface."
  focus: "I built a synthetic Tiger Brands portfolio dataset to test how category role, pack-size fit, repeat purchase, and cross-category lift move across Gauteng households."
  outcome: "The case shows where staples hold loyalty, where snacks broaden the basket, and where the strongest growth opportunities sit once commercial quality is considered alongside volume."
